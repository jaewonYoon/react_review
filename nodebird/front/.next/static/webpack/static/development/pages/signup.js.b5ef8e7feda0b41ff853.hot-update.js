...
var AppLayout = function AppLayout(_ref) {
  ...
  return __jsx("div", {
    ...
    actions: [// <div key="twit">쨱짹<br/>{dummy.Post.length}</div>,
      // <div key="following">팔로잉<br/>{dummy.Follwings.length}</div>,
...
//# sourceMappingURL=signup.js.b5ef8e7feda0b41ff853.hot-update.js.map